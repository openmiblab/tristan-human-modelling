...
\begin{figure}[h!]%
\centering%
\includegraphics[width=6in]{C:/Users/md1spsx/Documents/GitHub/tristan-human-stage-2-modelling/build/rifampicin_clinical/results (two scans)/Figures/_compare_to_ref.png}%
...
\begin{figure}[h!]%
\centering%
\includegraphics[width=7in]{C:/Users/md1spsx/Documents/GitHub/tristan-human-stage-2-modelling/build/rifampicin_clinical/results (one scan)/Figures/_effect_plot.png}%
\caption{Effect size (\%) on hepatocellular uptake (k\_he, left) and biliary excretion (k\_bh, right) of gadoxetate. The boxplot shows median, interquartile range and 95 percent range. The line plots show individual values for hepatocellular uptake (k\_he, middle) and biliary excretion (k\_bh, right) of gadoxetate of the control (left of plot) and treatment (right of plot). Grey lines are healthy controls with rifampicin injection.}%
\end{figure}
...
\begin{figure}[h!]%
\centering%
\includegraphics[width=4.5in]{C:/Users/md1spsx/Documents/GitHub/tristan-human-stage-2-modelling/build/rifampicin_clinical/results (one scan)/Plots/GOT-001_control.png}%
\caption{Signal{-}time curves for subject GOT{-}001 at the control visit.}%
\end{figure}
...
\begin{figure}[h!]%
\centering%
\includegraphics[width=4.5in]{C:/Users/md1spsx/Documents/GitHub/tristan-human-stage-2-modelling/build/rifampicin_clinical/results (one scan)/Plots/GOT-001_drug.png}%
\caption{Signal{-}time curves for subject GOT{-}001 at the treatment visit.}%
\end{figure}
...
\begin{figure}[h!]%
\centering%
\includegraphics[width=4.5in]{C:/Users/md1spsx/Documents/GitHub/tristan-human-stage-2-modelling/build/rifampicin_clinical/results (one scan)/Plots/GOT-002_control.png}%
\caption{Signal{-}time curves for subject GOT{-}002 at the control visit.}%
\end{figure}
...
\begin{figure}[h!]%
\centering%
\includegraphics[width=4.5in]{C:/Users/md1spsx/Documents/GitHub/tristan-human-stage-2-modelling/build/rifampicin_clinical/results (one scan)/Plots/GOT-002_drug.png}%
\caption{Signal{-}time curves for subject GOT{-}002 at the treatment visit.}%
\end{figure}
...
\begin{figure}[h!]%
\centering%
\includegraphics[width=4.5in]{C:/Users/md1spsx/Documents/GitHub/tristan-human-stage-2-modelling/build/rifampicin_clinical/results (one scan)/Plots/GOT-003_control.png}%
\caption{Signal{-}time curves for subject GOT{-}003 at the control visit.}%
\end{figure}
...
\begin{figure}[h!]%
\centering%
\includegraphics[width=4.5in]{C:/Users/md1spsx/Documents/GitHub/tristan-human-stage-2-modelling/build/rifampicin_clinical/results (one scan)/Plots/GOT-003_drug.png}%
\caption{Signal{-}time curves for subject GOT{-}003 at the treatment visit.}%
\end{figure}
